			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="panel panel-default">
					  ...
					  <div class="panel-heading">Вся Недвижимость <a class="btn btn-primary pull-right" href="admin_add_products.php">Добавить</a></div>
						...
						$result= $conn->query($sql);
							...
							if($result){
								...
								while($row = $result->fetch_array()){
									...
									echo "<td>".$status."</td>";
									echo "<td><a href='admin_products.php?Dpid=".$row['pr_id']."'>Удалить</a></td>";
									echo "</tr>";
								}
