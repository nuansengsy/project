	...
	<div class="row">
		...
		<?php echo $message; ?>
			...
			<form role="form" method="post" action="">
			    <div class="radio">
			      <label><input type="radio" name="payment" value="Bank Transfer">Банковский Перевод</label>
			    </div>
			    <div class="radio">
			      <label><input type="radio" name="payment" checked="checked" value="Cash on delivery">Наличные</label>
			    </div>
