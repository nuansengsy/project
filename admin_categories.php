			...
			<div class="row">
				<div class="col-sm-4">
					<div class="list-group">
					  ...
					  <a href="admin_categories.php" class="list-group-item active">Категории</a>
					  ...
					  <div class="panel-body">
					    	...
					    	<form class="form-inline" role="form" method="post" action="">
							  <div class="form-group">
							    ...
							    <input type="text" name="catname" class="form-control" id="name" placeholder="Название" required>
							  </div>
							  <div class="form-group">

							    <textarea name="catdesc" placeholder="Описание" cols="40"></textarea>
							  </div>
					  ...
					  $sql2 = "SELECT * FROM categories";
						...
						if($result){
							...
							while($row = $result->fetch_array()){
								echo "<li class='list-group-item'>".$row['cat_name']." <a class='btn btn-default btn-sm glyphicon glyphicon-trash pull-right' href='admin_categories.php?Cid=".$row['cat_id']."'> Удалить</a></li>";
							}
