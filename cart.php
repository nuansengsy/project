    ...
    <div class="container">
        ...
        <?php echo $message; ?>
            <div class="col-sm-12">
              ...
              <div class="pull-right "><a  class="btn btn-primary" href="checkout.php">К Оплате</a>
              </div><br> <br>
                <div class="pull-right btn btn-default"><?php echo "Итог: $".$carttotal; ?></div>
                <a class=" btn btn-warning pull-left" href="cart.php?cmd=cart">Очистить Корзину</a>
            </div>
        </div>
    </div>
